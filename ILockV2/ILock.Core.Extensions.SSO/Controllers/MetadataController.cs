    ...
    public class MetadataController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            entityDescriptor.SPSsoDescriptor = new SPSsoDescriptor
            {
                ...
                {
                    new SingleLogoutService { Binding = ProtocolBindings.HttpPost, Location = new Uri(defaultSite, "SSO/SingleLogout"), ResponseLocation = new Uri(defaultSite, "SSO/LoggedOut") }
                },
